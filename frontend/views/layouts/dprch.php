            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php if(Yii::$app->user->isGuest) {?>
                        <div class="top_links">
                            <a href="<?= Url::toRoute(['site/signup'])?>">Регістрація</a> /
                            <a href="<?= Url::toRoute(['site/login'])?>">Зайти</a>
                        </div>
                    <?php } else {?>
                        <div class="logout">
                ...
                <div class="row">
                    <nav class="main_mnu clearfix">
                        ...
                        <ul>
                            ...
                            <li><a href="<?= Url::to(['/dprch/default/photogallery'])?>">Фотогалерея</a></li>
